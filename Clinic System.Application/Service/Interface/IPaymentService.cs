namespace Clinic_System.Application.Service.Interface
{
    public interface IPaymentService
    {
        ...
        Task<Payment> RefundAsync(int paymentId, string? reason = null, decimal? amount = null, CancellationToken cancellationToken = default);
        Task<Payment> CancelAsync(int paymentId, string? reason = null, CancellationToken cancellationToken = default);
        Task<Payment> ApplyDiscountAsync(int paymentId, decimal discountAmount, CancellationToken cancellationToken = default);
        Task<Payment> VoidReceiptAsync(int paymentId, int receiptId, string? reason = null, CancellationToken cancellationToken = default);
    }
}
